!(function (e, t) {
  ...
  ; (C.fn = C.prototype = {
    ...
    (C.extend = C.fn.extend = function () {
      var e,
        ...
        d = !1
      for (
        'boolean' == typeof s && ((d = s), (s = arguments[a] || {}), a++),
        ...
        if (null != (e = arguments[a]))
          for (t in e)
            (n = e[t]),
              '__proto__' !== t &&
              s !== n &&
              (d && n && (C.isPlainObject(n) || (o = Array.isArray(n)))
                ? ((i = s[t]),
                  (r =
                    o && !Array.isArray(i)
                      ? []
  ...
  var h = (function (i) {
    ...
    function ae (e, t, i, n) {
      ...
      if (
        !n &&
        ((t ? t.ownerDocument || t : y) !== T && k(t), (t = t || T), S)
      ) {
        if (11 !== p && (l = K.exec(e)))
          if ((o = l[1])) {
            if (9 === p) {
    ...
    for (e in ((f = ae.support = {}),
              ...
              ? function (e, t) {
                ...
                return (
                  ...
                  (1 &
                    ...
                    ? e === T || (e.ownerDocument === y && m(y, e))
                      ? -1
                      : t === T || (t.ownerDocument === y && m(y, t))
                        ? 1
                        : l
                          ? O(l, e) - O(l, t)
                          : 0
      ...
      (ae.attr = function (e, t) {
        ...
        var i = w.attrHandle[t.toLowerCase()],
          n = i && j.call(w.attrHandle, t.toLowerCase()) ? i(e, t, !S) : void 0
        return void 0 !== n
          ? n
          : f.attributes || !S
            ? e.getAttribute(t)
      ...
      ((w = ae.selectors = {
                ...
                if (c) {
                  if (m) {
                    for (; d;) {
                      for (s = e; (s = s[d]);)
                        if (
                          b ? s.nodeName.toLowerCase() === u : 1 === s.nodeType
                        )
                          return !1
        ...
        pseudos: {
          ...
          lang: de(function (i) {
            return (
              V.test(i || '') || ae.error('unsupported lang: ' + i),
      ...
      return (
        ...
        de(function (e, t, i, n) {
          var o,
            ...
            u = !f || (!e && h) ? c : ke(c, a, f, i, n),
            p = g ? (m || (e ? f : d || v) ? [] : t) : u
          if ((g && g(u, p, i, n), v))
            for (o = ke(p, l), v(o, [], i, n), r = o.length; r--;)
              (s = o[r]) && (p[l[r]] = !(u[l[r]] = s))
          if (e) {
            if (m || f) {
              if (m) {
          ...
          } else (p = ke(p === t ? p.splice(d, p.length) : p)), m ? m(null, t, p, n) : q.apply(t, p)
        })
      )
    }
    function Se (e) {
    ...
    return (
      ...
      (h = ae.tokenize = function (e, t) {
        ...
        for (s = e, a = [], l = w.preFilter; s;) {
          for (r in ((i && !(n = _.exec(s))) ||
            (n && (s = s.slice(n[0].length) || s), a.push((o = []))),
            (i = !1),
            (n = B.exec(s)) &&
            ((i = n.shift()),
              o.push({ value: i, type: n[0].replace(W, ' ') }),
              (s = s.slice(i.length))),
            w.filter))
            !(n = Y[r].exec(s)) ||
              (l[r] && !(n = l[r](n))) ||
      ...
      (u = ae.compile = function (e, t) {
        var i,
          ...
          s = A[e + ' ']
        if (!s) {
          for (t || (t = h(e)), i = t.length; i--;)
            (s = Se(t[i]))[C] ? o.push(s) : r.push(s)
              ; (s = A(
                e,
                ((v = r),
                  (y = 0 < (m = o).length),
                  ...
                  (n = function (e, t, i, n, o) {
                    ...
                    for (
                      ...
                      if (b && r) {
                        for (
                          s = 0, t || r.ownerDocument === T || (k(r), (i = !S));
                          (a = v[s++]);
      ...
      (g = ae.select = function (e, t, i, n) {
        ...
        if (((i = i || []), 1 === c.length)) {
          if (
            ...
            if (!(t = (w.find.ID(s.matches[0].replace(te, ie), t) || [])[0]))
              return i
  ...
  ; (C.filter = function (e, t, i) {
    ...
    C.fn.extend({
      ...
      is: function (e) {
        return !!j(this, 'string' == typeof e && A.test(e) ? C(e) : e || [], !1)
          .length
      }
    })
  var N,
      ...
      function (n, o) {
        C.fn[n] = function (e, t) {
          ...
          return (
            ...
            1 < this.length &&
            (H[n] || C.uniqueSort(i), q.test(n) && i.reverse()),
            this.pushStack(i)
          )
        }
      }
  ...
  ; (C.Callbacks = function (n) {
    ...
    var o,
      ...
      d = -1,
      c = function () {
        for (s = s || n.once, r = o = !0; l.length; d = -1)
          for (t = l.shift(); ++d < a.length;)
            !1 === a[d].apply(t[0], t[1]) &&
              n.stopOnFalse &&
              ((d = a.length), (t = !1))
      ...
      u = {
        add: function () {
          return (
            a &&
            (t && !o && ((d = a.length - 1), l.push(t)),
              (function i (e) {
                C.each(e, function (e, t) {
                  y(t)
                    ? (n.unique && u.has(t)) || a.push(t)
                    : t && t.length && 'string' !== x(t) && i(t)
                })
              })(arguments),
              t && !o && c()),
            this
    ...
    C.extend({
          ...
          s = {
            ...
            then: function (t, i, n) {
                      ...
                      if (!(o < l)) {
                        if ((e = s.apply(i, n)) === r.promise())
                          ...
                          ; (t =
                            ...
                            y(t)
                              ? a
                                ? t.call(e, d(l, r, M, a), d(l, r, I, a))
                                : (l++ ,
                                  t.call(
                                    e,
                                    d(l, r, M, a),
                                    d(l, r, I, a),
                                    d(l, r, M, r.notifyWith)
                                  ))
                              : (s !== M && ((i = void 0), (n = [e])),
                                (a || r.resolveWith)(i, n))
                      }
              ...
              return C.Deferred(function (e) {
                r[0][3].add(d(0, e, y(n) ? n : M, e.notifyWith)),
                  r[1][3].add(d(0, e, y(t) ? t : M)),
                  r[2][3].add(d(0, e, y(i) ? i : I))
              }).promise()
            },
            promise: function (e) {
      ...
      when: function (e) {
        ...
        if (
          i <= 1 &&
          (z(e, r.done(s(t)).resolve, r.reject, !i),
  ...
  var _ = function (e, t, i, n, o, r, s) {
    var a = 0,
      l = e.length,
      d = null == i
    if ('object' === x(i)) for (a in ((o = !0), i)) _(e, t, a, i[a], !0, r, s)
    else if (
      void 0 !== n &&
      ((o = !0),
        y(n) || (s = !0),
  ...
  var ce = {}
  function ue (e, t) {
    for (var i, n, o, r, s, a, l, d = [], c = 0, u = e.length; c < u; c++)
      (n = e[c]).style &&
        ((i = n.style.display),
          t
            ? ('none' === i &&
              ((d[c] = Q.get(n, 'display') || null),
                d[c] || (n.style.display = '')),
              '' === n.style.display &&
              ae(n) &&
              (d[c] =
                ((l = s = r = void 0),
                  ...
                  ((r = s.body.appendChild(s.createElement(a))),
                    ...
                    'none' === l && (l = 'block'),
                    (ce[a] = l)))))
            : 'none' !== i && ((d[c] = 'none'), Q.set(n, 'display', i)))
      ...
      (i =
        void 0 !== e.getElementsByTagName
          ...
          : void 0 !== e.querySelectorAll
            ...
            : []),
      void 0 === t || (t && E(e, t)) ? C.merge([e], i) : i
    )
  }
  function me (e, t) {
  ...
  function xe (e, t, i, n, o) {
    ...
    for (u.textContent = '', f = 0; (r = p[f++]);)
      if (n && -1 < C.inArray(r, n)) o && o.push(r)
        ...
        ((d = re(r)), (s = ve(u.appendChild(r), 'script')), d && me(s), i)
      )
        for (c = 0; (r = s[c++]);) he.test(r.type || '') && i.push(r)
    return u
  }
            ...
            if (1 & e.isTrigger && this[o]) {
              if (n.length)
                ...
                ((n = a.call(arguments)),
                  ...
                  (t = r(this, o)),
                  this[o](),
                  n !== (i = Q.get(this, o)) || t ? Q.set(this, o, !1) : (i = {}),
                  n !== i)
              )
  ...
  ; (C.event = {
          ...
          (f = g = (a = Se.exec(e[d]) || [])[1]),
            ...
            ((u = C.event.special[f] || {}),
              ...
              (((p = l[f] = []).delegateCount = 0),
                (u.setup && !1 !== u.setup.call(t, n, h, s)) ||
    ...
    dispatch: function (e) {
      ...
      if (
        ...
        for (
          s = C.event.handlers.call(this, a, d), t = 0;
    ...
    handlers: function (e, t) {
      ...
      return (
        (d = this), l < t.length && a.push({ elem: d, handlers: t.slice(l) }), a
      )
    },
    ...
    special: {
      ...
      click: {
        setup: function (e) {
          var t = this || e
          return (
            pe.test(t.type) && t.click && E(t, 'input') && Le(t, 'click', Ce),
            !1
          )
        },
        trigger: function (e) {
          var t = this || e
          return (
            pe.test(t.type) && t.click && E(t, 'input') && Le(t, 'click'), !0
          )
        },
        _default: function (e) {
          var t = e.target
  ...
  function Me (e, t) {
    ...
    if (1 === t.nodeType) {
      if (
        Q.hasData(e) &&
        ((r = Q.access(e)), (s = Q.set(t, r)), (d = r.events))
      )
  ...
  function Ie (i, n, o, r) {
    ...
    var e,
      ...
      f = n[0],
      h = y(f)
    if (h || (1 < u && 'string' == typeof f && !m.checkClone && De.test(f)))
      return i.each(function (e) {
        var t = i.eq(e)
        h && (n[0] = f.call(this, e, t.html())), Ie(t, n, o, r)
      })
    if (
      u &&
      ((t = (e = xe(n, i[0].ownerDocument, !1, i, r)).firstChild),
        1 === e.childNodes.length && (e = t),
        t || r)
    ) {
      for (a = (s = C.map(ve(e, 'script'), Oe)).length; c < u; c++)
        (l = e),
          c !== p &&
          ((l = C.clone(l, !0, !0)), a && C.merge(s, ve(l, 'script'))),
          o.call(i[c], l, c)
      if (a)
        for (d = s[s.length - 1].ownerDocument, C.map(s, Pe), c = 0; c < a; c++)
          (l = s[c]),
            he.test(l.type || '') &&
            ...
            (l.src && 'module' !== (l.type || '').toLowerCase()
              ...
              : w(l.textContent.replace(qe, ''), l, d))
    }
    return i
  }
  function ze (e, t, i) {
    for (var n, o = t ? C.filter(t, e) : e, r = 0; null != (n = o[r]); r++)
      i || 1 !== n.nodeType || C.cleanData(ve(n)),
        n.parentNode &&
        (i && re(n) && me(ve(n, 'script')), n.parentNode.removeChild(n))
    return e
  }
  C.extend({
    ...
    clone: function (e, t, i) {
      ...
      if (
        ...
        for (s = ve(c), n = 0, o = (r = ve(e)).length; n < o; n++)
          (a = r[n]),
            'input' === (d = (l = s[n]).nodeName.toLowerCase()) &&
              pe.test(a.type)
              ? (l.checked = a.checked)
              : ('input' !== d && 'textarea' !== d) ||
      ...
      if (t)
        if (i)
          for (r = r || ve(e), s = s || ve(c), n = 0, o = r.length; n < o; n++)
            Me(r[n], s[n])
        else Me(e, c)
      return 0 < (s = ve(c, 'script')).length && me(s, !u && ve(e, 'script')), c
    },
    ...
    return (
      ...
      (e in Xe
        ...
        : (Ve[e] =
          (function (e) {
            for (
              var t = e[0].toUpperCase() + e.slice(1), i = Ue.length;
              i--;
  ...
  function et (e, t, i, n, o, r) {
    ...
    for (; s < 4; s += 2)
      'margin' === i && (l += C.css(e, i + ne[s], !0, o)),
        n
          ? ('content' === i && (l -= C.css(e, 'padding' + ne[s], !0, o)),
            'margin' !== i &&
  ...
  function tt (e, t, i) {
    ...
    return (
      ...
      ((o = 'border-box' === C.css(e, 'boxSizing', !1, n)),
        (r = a in e) && (s = e[a])),
      (s = parseFloat(s) || 0) +
      et(e, t, i || (o ? 'border' : 'content'), r, n, s) +
      'px'
    )
  }
    ...
    style: function (e, t, i, n) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        var o,
          ...
          d = e.style
        if (
          (l || (t = Ye(a)), (s = C.cssHooks[t] || C.cssHooks[a]), void 0 === i)
        )
      ...
      ; (C.cssHooks[o + r] = {
        expand: function (e) {
          for (
            ...
            i[o + ne[t] + r] = n[t] || n[t - 2] || n[0]
          return i
        }
      }),
        'margin' !== o && (C.cssHooks[o + r].set = Ke)
    }),
    C.fn.extend({
      css: function (e, t) {
        return _(
  ...
  function ft (r, e, t) {
    var i,
      ...
      l = function () {
        ...
        for (
          var e = nt || ct(),
          t = Math.max(0, d.startTime + d.duration - e),
          i = 1 - (t / d.duration || 0),
          n = 0,
          o = d.tweens.length;
          n < o;
          ...
          d.tweens[n].run(i)
        return (
          a.notifyWith(r, [d, i, t]),
          i < 1 && o
            ? t
            : (o || a.notifyWith(r, [d, 1, 0]), a.resolveWith(r, [d]), !1)
        )
      },
      d = a.promise({
        elem: r,
        ...
        stop: function (e) {
          ...
          return (
            e
              ? (a.notifyWith(r, [d, 1, 0]), a.resolveWith(r, [d, e]))
              : a.rejectWith(r, [d, e]),
            this
          )
        }
    ...
    for (
      ...
      if ((i = ft.prefilters[n].call(d, r, c, d.opts)))
        return (
          y(i.stop) &&
    ...
    return (
      C.map(c, pt, d),
      y(d.opts.start) && d.opts.start.call(r, d),
      d
  ...
  ; (C.Animation = C.extend(ft, {
    ...
    tweener: function (e, t) {
      for (
        var i, n = 0, o = (e = y(e) ? ((t = e), ['*']) : e.match(P)).length;
        n < o;
        n++
      )
        (i = e[n]),
          (ft.tweeners[i] = ft.tweeners[i] || []),
          ft.tweeners[i].unshift(t)
    },
    prefilters: [
      function (e, t, i) {
        var n,
          ...
          for (n in (u &&
            ...
            l ||
              (v
                ...
                : (v = Q.access(e, 'fxshow', { display: d })),
                r && (v.hidden = !g),
                g && ue([e], !0),
                p.done(function () {
                  for (n in (g || ue([e]), Q.remove(e, 'fxshow'), f))
                    C.style(e, n, f[n])
                })),
              (l = pt(g ? v[n] : 0, n, p)),
              n in v ||
      ...
      stop: function (o, e, r) {
        ...
        return (
          ...
          this.each(function () {
            ...
            else for (t in n) n[t] && n[t].stop && lt.test(t) && s(n[t])
            for (t = i.length; t--;)
              i[t].elem !== this ||
                (null != o && i[t].queue !== o) ||
    ...
    (st = S.createElement('select').appendChild(S.createElement('option'))),
    (rt.type = 'checkbox'),
    (m.checkOn = '' !== rt.value),
    (m.optSelected = st.selected),
    ...
    C.fn.extend({
      ...
      hasClass: function (e) {
        var t,
          ...
          n = 0
        for (t = ' ' + e + ' '; (i = this[n++]);)
          if (1 === i.nodeType && -1 < (' ' + yt(bt(i)) + ' ').indexOf(t))
            return !0
        return !1
      }
    })
    ...
    trigger: function (e, t, i, n) {
      ...
      if (
        ((r = u = s = i = i || S),
          3 !== i.nodeType &&
          8 !== i.nodeType &&
          !kt.test(f + C.event.triggered) &&
          (-1 < f.indexOf('.') && ((f = (h = f.split('.')).shift()), h.sort()),
            (l = f.indexOf(':') < 0 && 'on' + f),
            ((e = e[C.expando]
              ? e
              : new C.Event(f, 'object' == typeof e && e)).isTrigger = n ? 2 : 3),
            (e.namespace = h.join('.')),
        ...
        if (!n && !c.noBubble && !b(i)) {
          for (
            a = c.delegateType || f, kt.test(a + f) || (r = r.parentNode);
            r;
            r = r.parentNode
          )
            p.push(r), (s = r)
    ...
    C.each({ focus: 'focusin', blur: 'focusout' }, function (i, n) {
      ...
      C.event.special[n] = {
        ...
        teardown: function () {
          ...
          t
            ? Q.access(e, n, t)
            : (e.removeEventListener(i, o, !0), Q.remove(e, n))
        }
      }
    })
  var St = T.location,
  ...
  function Nt (i, e, n, o) {
    ...
    else for (t in e) Nt(i + '[' + t + ']', e[t], n, o)
  }
  ...
  ; (Ft.href = St.href),
    C.extend({
      ...
      ajax: function (e, t) {
        ...
        if (
          ...
          try {
            ; (n.href = v.url),
              (n.href = n.href),
              (v.crossDomain =
                Ft.protocol + '//' + Ft.host != n.protocol + '//' + n.host)
          } catch (e) {
            v.crossDomain = !0
          }
        }
        ...
        for (o in ((g = C.event && v.global) &&
          ...
          v.hasContent
            ...
            : ((r = v.url.slice(u.length)),
              ...
              ((u += ($t.test(u) ? '&' : '?') + v.data), delete v.data),
              !1 === v.cache &&
              ((u = u.replace(Ht, '$1')),
                (r = ($t.test(u) ? '&' : '?') + '_=' + Ct++ + r)),
              (v.url = u + r)),
        ...
        if (v.beforeSend && (!1 === v.beforeSend.call(m, k, v) || h))
          return k.abort()
        if (
          ((l = 'abort'),
            w.add(v.complete),
          ...
          if (((k.readyState = 1), g && y.trigger('ajaxSend', [k, v]), h))
            return k
          v.async &&
            0 < v.timeout &&
              ...
              o
                ? (v.ifModified &&
                  ((l = k.getResponseHeader('Last-Modified')) &&
                    (C.lastModified[u] = l),
                    (l = k.getResponseHeader('etag')) && (C.etag[u] = l)),
                  204 === e || 'HEAD' === v.type
                    ? (d = 'nocontent')
                    : 304 === e
                      ? (d = 'notmodified')
                      : ((d = a.state), (r = a.data), (o = !(s = a.error))))
                : ((s = d), (!e && d) || ((d = 'error'), e < 0 && (e = 0))),
              (k.status = e),
              (k.statusText = (t || d) + ''),
              o ? b.resolveWith(m, [r, d, k]) : b.rejectWith(m, [k, d, s]),
              k.statusCode(x),
              (x = void 0),
              g && y.trigger(o ? 'ajaxSuccess' : 'ajaxError', [k, v, o ? r : s]),
              w.fireWith(m, [k, d]),
              g &&
  ...
  C.ajaxSetup({
    ...
    C.ajaxPrefilter('json jsonp', function (e, t, i) {
      ...
      if (s || 'jsonp' === e.dataTypes[0])
        return (
          (n = e.jsonpCallback = y(e.jsonpCallback)
            ? e.jsonpCallback()
            : e.jsonpCallback),
          s
            ? (e[s] = e[s].replace(Gt, '$1' + n))
            : !1 !== e.jsonp &&
            (e.url += ($t.test(e.url) ? '&' : '?') + e.jsonp + '=' + n),
    ...
    (C.parseHTML = function (e, t, i) {
      return 'string' != typeof e
        ...
        : ('boolean' == typeof t && ((i = t), (t = !1)),
          t ||
          (m.createHTMLDocument
            ? (((n = (t = S.implementation.createHTMLDocument(
              ''
    ...
    (C.fn.load = function (e, t, i) {
      var n,
        ...
        a = e.indexOf(' ')
      return (
        -1 < a && ((n = yt(e.slice(a))), (e = e.slice(0, a))),
        y(t)
          ? ((i = t), (t = void 0))
    ...
    C.each(['top', 'left'], function (e, i) {
      C.cssHooks[i] = Be(m.pixelPosition, function (e, t) {
        if (t) return (t = _e(e, i)), Re.test(t) ? C(e).position()[i] + 'px' : t
      })
    }),
  ...
  return (
    (C.noConflict = function (e) {
      return T.$ === C && (T.$ = Zt), e && T.jQuery === C && (T.jQuery = Qt), C
    }),
    e || (T.jQuery = T.$ = C),
    C
  )
      ...
      c &&
        (function e () {
          for (var t = 0; t < h.length;) {
            ...
            if (
              (!r && u.attributeName && (r = i.getAttribute(u.attributeName)),
                o && r)
            ) {
              if (c)
                if (!u.validate || u.validate(r, o, i)) {
                  ...
                  if (a.length) {
                    var d = p[a]
                    d ||
                      ((d = p[a] = new XMLHttpRequest()).open('GET', a),
                        d.send(),
                        (d._embeds = [])),
                      d._embeds.push({ parent: n, svg: o, id: l }),
                      m(d)
                  } else v(n, o, document.getElementById(l))
                } else ++t, ++g
            } else ++t
          }
      ...
      rules: function (e, t) {
        ...
        if (
          ...
          return (
            ...
            ((s = r.required),
              delete r.required,
              (r = c.extend({ required: s }, r))),
            r.remote &&
            ((s = r.remote),
              delete r.remote,
              (r = c.extend(r, { remote: s }))),
            r
          )
        }
      }
      ...
      c.extend(c.validator, {
        ...
        prototype: {
            ...
            function e (e) {
              ...
              if (
                ...
                var i = c.data(this.form, 'validator'),
                  ...
                  o = i.settings
                o[n] && !c(this).is(o.ignore) && o[n].call(i, this, e)
              }
            }
            ...
            return c(this.currentForm)
              ...
              .filter(function () {
                ...
                return (
                  ...
                  t &&
                  ((this.form = c(this).closest('form')[0]), (this.name = e)),
                  !(
          ...
          defaultMessage: function (e, t) {
            ...
            return (
              'function' == typeof i
                ...
                : n.test(i) &&
                (i = c.validator.format(i.replace(n, '{$1}'), t.parameters)),
              i
            )
          },
          ...
          showLabel: function (e, t) {
            ...
            s.length
              ? (s
                ...
                s.html(t))
              : ((i = s = c('<' + this.settings.errorElement + '>')
                .attr('id', a + '-error')
                .addClass(this.settings.errorClass)
                .html(t || '')),
                this.settings.wrapper &&
                ...
                this.labelContainer.length
                  ...
                  : this.settings.errorPlacement
                    ? this.settings.errorPlacement.call(this, i, c(e))
                    : i.insertAfter(e),
                s.is('label')
                  ? s.attr('for', a)
                  : 0 ===
          ...
          errorsFor: function (e) {
            ...
            return (
              i &&
              (n = n + ', #' + this.escapeCssMeta(i).replace(/\s+/g, ', #')),
          ...
          for (t in c.validator.methods)
            (i =
              'required' === t
                ...
                : o.attr(t)),
              this.normalizeAttributeRule(n, r, t, i)
          return (
            n.maxlength &&
        ...
        staticRules: function (e) {
          ...
          return (
            i.settings.rules &&
            (t = c.validator.normalizeRule(i.settings.rules[e.name]) || {}),
            t
          )
        },
            ...
            c.each(n, function (e, t) {
              if (!1 !== t) {
                if (t.param || t.depends) {
                  ...
                  i
                    ? (n[e] = void 0 === t.param || t.param)
                    : (c.data(o.form, 'validator').resetElements(c(o)),
                      delete n[e])
                }
              } else delete n[e]
            }),
            c.each(n, function (e, t) {
              n[e] = c.isFunction(t) && 'normalizer' !== e ? t(o) : t
            }),
        ...
        methods: {
          ...
          remote: function (r, s, e, a) {
            ...
            var l,
              t,
              i,
              d = this.previousValue(s, a)
            return (
              this.settings.messages[s.name] ||
              (this.settings.messages[s.name] = {}),
              (d.originalMessage =
                d.originalMessage || this.settings.messages[s.name][a]),
              (this.settings.messages[s.name][a] = d.message),
              (e = ('string' == typeof e && { url: e }) || e),
              (i = c.param(c.extend({ data: r }, e.data))),
              d.old === i
                ? d.valid
                : ((d.old = i),
                      ...
                      !0,
                      {
                        ...
                        success: function (e) {
                          var t,
                            ...
                            n,
                            o = !0 === e || 'true' === e
                            ; (l.settings.messages[s.name][a] = d.originalMessage),
                              o
                                ? ((n = l.formSubmitted),
                                  l.resetInternals(),
    ...
    if ('IntersectionObserver' in window) {
      ...
      var r = new IntersectionObserver(function (e, t) {
        e.forEach(function (e) {
          if (e.isIntersecting) {
            var t = e.target
              ; (t.style.backgroundImage = 'url('.concat(t.dataset.bg, ')')),
                r.unobserve(t)
          }
        })
      })
      ...
      e.forEach(function (e) {
        ...
        i.forEach(function (e) {
          e.style.backgroundImage = 'url('.concat(e.dataset.bg, ')')
        })
  }),
      ...
      c = function () {
        ...
        e &&
          (e.offset().left <= '80' &&
            ...
            ? ($('.slide-prev').addClass('arrow-inside'),
              $('.slide-next').addClass('arrow-inside'))
            : ($('.slide-prev').removeClass('arrow-inside'),
              $('.slide-next').removeClass('arrow-inside')))
      }
    $(document).on('click', '.select__header', function () {
      $(this)
        .parent()
        .toggleClass('select_open')
    }),
      $(document).on('click', '.select-list__item', function () {
        var e = $(this)
          .closest('.select')
          .find('.select__current')[0]
        $(this)
          .closest('.select')
          .removeClass('select_open'),
          $(e).text($(this).text())
      }),
      $('.slider').slick({
        infinite: !1,
      ...
      $('.slider').slick('slickRemove', '#hidethisslide'),
      (e = $('.current-weather__toggle')),
      (t = $('.current-weather-row')),
      (i = $('.current-weather-wrap')),
      (n = $('.current-weather__title')),
      (o = $('.current-weather__arrow')),
      e.on('click', function () {
        t.toggleClass('show'),
          i.toggleClass('show'),
          n.toggleClass('show'),
      ...
      $('.restaurant-menu__slider').slick({
        ...
        arrows: !0,
        speed: 350,
        prevArrow: '.restaurant-menu-prev',
        nextArrow: '.restaurant-menu-next',
        responsive: [
          {
            breakpoint: 768,
            settings: {
      ...
      $('.restaurant-menu__slider').slick('slickRemove', '#hidethisslide'),
      $('.gallery-slide__block').slick({
        slidesToShow: 1,
        slidesToScroll: 1,
        speed: 350,
        ...
        responsive: [{ arrows: !0, breakpoint: 768 }]
      }),
      $('.gallery-slider-nav').slick({
        ...
        speed: 350,
        verticalSwiping: !0,
        asNavFor: '.gallery-slide__block',
        responsive: [
          { breakpoint: 768, variableWidth: !1, settings: 'unslick' }
        ]
      }),
      $('.slider-prev-shales').on('init afterChange', function (e, t, i, n) {
        var o = $('.prev-shales-arrow-prev .arrow__title'),
          r = $('.slick-current')
            .prev()
            .attr('data-bar')
        o.text(r)
      }),
      $('.slider-prev-shales').on('init beforeChange', function (e, t, i, n) {
        var o = $('.prev-shales-arrow-next .arrow__title'),
          r = $('.slick-current')
            .next()
            .attr('data-bar')
        o.text(r),
      ...
      $('.slider-prev-shales').slick({
        slidesToShow: 1,
        slidesToScroll: 1,
        cssEase: 'linear',
        arrows: !0,
        speed: 350,
        prevArrow: '.prev-shales-arrow-prev',
        nextArrow: '.prev-shales-arrow-next'
      }),
      $('.shale-photo-gallery__slider').slick({
        infinite: !1,
        slidesToScroll: 1,
        slidesToShow: 1,
        swipeToSlide: !0,
        ...
        speed: 350,
        cssEase: 'linear',
        prevArrow: '.shale-photo-gallery-prev',
        nextArrow: '.shale-photo-gallery-next',
        dots: !0,
        customPaging: function () {
          return '<a class="shale-photo-gallery-dots"></a>'
        }
      }),
      $('.shale-photo-gallery__slider').slick('slickRemove', '#hidethisslide'),
      $('.slider-tariffs').slick({
        infinite: !1,
        speed: 350,
        slidesToScroll: 1,
        slidesToShow: 3,
        prevArrow: '.slider-tariffs__arrow-prev',
        nextArrow: '.slider-tariffs__arrow-next',
        autoplay: !1,
        arrows: !0,
        cssEase: 'linear',
        responsive: [
      ...
      $('.slowly').on('click', function (e) {
        e.preventDefault()
        var t = $(this).attr('href'),
          i = $(t).offset().top
        $('body,html').animate({ scrollTop: i }, 600)
      }),
      c(),
      (r = $('.hamburger')),
      (s = $('.main-logo__link')),
      ...
      $('.tariff-table').removeClass('is-active'),
      $('#month0').addClass('is-active'),
      (d = $('.tariff-table')),
      $('.slider-tariffs__button').on('click', function () {
        var e = $(this).attr('data-target')
        d.removeClass('is-active'), $('#'.concat(e)).addClass('is-active')
      }),
      $('form').each(function () {
          ...
          if (
            ($(this).validate({
              ...
              errorPlacement: function (e, t) {
                $('.form__input-wrapper').addClass('focus'),
                  t.attr('placeholder', e[0].outerText)
              }
            }),
              $(this).valid())
          ) {
            var e = $(this)[0].closest('.hide-on-success')
            e &&
              ($(e).hide(),
                $(e)
      ...
      ymaps.ready(function () {
        var e = new ymaps.Map(
          'map',
          { center: [43.658211, 40.316902], zoom: 17, controls: [] },
        ...
        var t = new ymaps.Placemark(
          e.getCenter(),
          { hintContent: 'Пихтовая аллея, дом 7' },
          {
            iconLayout: 'default#image',
            iconImageHref: '/shale/wp-content/uploads/2020/02/home.png',
            iconImageSize: [44, 63],
      ...
      $(window).on('load resize', function () {
        c(),
          $(document).width() < 768
            ? $('.gallery-slider-nav').slick('unslick')
            : $('.gallery-slider-nav')
